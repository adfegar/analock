    ...
    <View style={{ width: 60, height: 60 }}>
      <Svg width="60" height="60" viewBox="0 0 60 60" fill="none">
        ...
        <Path
          ...
          fill={
            activityCompletionMap.get(ActivityKind.Diary) ? colorPurple : "none"
          }
          stroke={
            activityCompletionMap.get(ActivityKind.Diary)
              ? "none"
              : colorWhiteBackground
          }
          strokeWidth="2"
        ...
        <Path
          ...
          fill={
            activityCompletionMap.get(ActivityKind.Book) ? colorGreen : "none"
          }
          stroke={
            activityCompletionMap.get(ActivityKind.Book)
              ? "none"
              : colorWhiteBackground
          }
          strokeWidth="2"
        ...
        <Path
          ...
          fill={
            activityCompletionMap.get(ActivityKind.Game) ? colorPink : "none"
          }
          stroke={
            activityCompletionMap.get(ActivityKind.Game)
              ? "none"
              : colorWhiteBackground
          }
          strokeWidth="2"
